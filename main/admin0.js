...
class Admin0 extends React.Component{
  constructor(){
    super()
    this.state={
      email:null,
    ...
    return(
      ...
      <View style={styles.body}>
        ...
        <View style={{alignItems:"center",justifyContent:"center",flex:1}}>
          <TouchableOpacity onPress={()=>this.props.navigation.navigate("Company2")} style={styles.button3} activeOpacity={0.5}>
          ...
          <TouchableOpacity style={styles.button2} onPress={()=>this.props.navigation.navigate("Student2")} activeOpacity={0.5}>
            <Text style={styles.start}>Companies Report</Text>
          </TouchableOpacity>
